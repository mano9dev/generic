...
export default {
  ...
  mounted(){
    this.$root.$on('enseignant:edit',(data) => {
      ...
      const enseignant = data;
      this.data.enseignant = enseignant;

      $('#'+'enseignant-create').modal('show');
    })
  },
